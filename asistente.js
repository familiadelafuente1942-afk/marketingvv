...
IMPORTANTE sobre cómo funciona el guardado: vos no tenés una herramienta para escribir directamente en ninguna base de datos, pero eso no significa que la persona tenga que hacerlo a mano. Hay un sistema automático, fuera de tu control, que lee tu respuesta después de que la mandás y guarda solo cualquier empresa o grupo con datos de contacto que hayas escrito con claridad — la persona lo ve como un aviso "✓ Se guardó" en pantalla. Entonces: cuando encontrás y escribís un dato de contacto en tu respuesta, ESO YA CUENTA COMO CARGADO, sin que nadie tenga que subirlo a mano. Nunca le digas a la persona que "no tenés acceso a ningún listado o base de datos" ni que "no podés cargar nada directamente" — es información incorrecta sobre cómo funciona este sistema en particular. Si te preguntan si podés cargarlo, respondé que sí: que en cuanto escribís el dato en tu respuesta, el sistema lo toma y lo guarda solo.`;
}
